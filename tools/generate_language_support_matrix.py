...
PASS_PACKAGE_EVIDENCE = (
    "make test VERSION=0.1.18; make package-deb package-rpm package-dotnet "
    "package-java package-node package-python package-go package-rust package-php "
    "package-ruby package-native-libraries package-perl VERSION=0.1.18; "
    "GitHub release v0.1.18 artifacts"
)
PASS_PYTHON_EVIDENCE = (
    "make package-python VERSION=0.1.18; isolated pip and pipx install/import/CLI/uninstall "
...
PASS_NODE_EVIDENCE = (
    "make test VERSION=0.1.18; make package-node VERSION=0.1.18; npm "
    "CommonJS/ESM import and run, strict TypeScript compile, bin, and uninstall validation"
)
PASS_WEB_CONSUMER_EVIDENCE = (
    "make package-web-language-consumers VERSION=0.1.18; clean npm installation from the "
...
PASS_DART_EVIDENCE = (
    "make package-dart-consumer VERSION=0.1.18; Dart SDK 3.12.2 resolves the packed npm "
...
PASS_CFML_EVIDENCE = (
    "make package-node VERSION=0.1.18; SSHFLING_NPM_PACKAGE=dist/sshfling-0.1.18.tgz "
...
PASS_FUNCTIONAL_LANGUAGES_EVIDENCE = (
    ...
    "dist/sshfling-functional-languages-0.1.18-validation.tsv"
)
PASS_SYSTEM_LANGUAGES_EVIDENCE = (
    "bash packaging/build-systems-languages.sh --allow-blocked; "
    "dist/sshfling-systems-languages-0.1.18-validation.tsv"
)
PASS_SWIFT_EVIDENCE = (
...
PASS_JAVA_EVIDENCE = (
    "make package-java VERSION=0.1.18; Maven clean install, Gradle clean build, "
    "executable/source/Javadocs artifacts, and clean Java, Kotlin, Scala, and Groovy consumers"
)
PASS_JVM_CONSUMER_EVIDENCE = (
    "make package-java VERSION=0.1.18; pinned Maven and Gradle compiler/build metadata, "
...
PASS_CLOJURE_EVIDENCE = (
    "make package-java VERSION=0.1.18; pinned Clojure 1.12 Maven and Gradle projects, "
...
PASS_DOTNET_EVIDENCE = (
    "make package-dotnet VERSION=0.1.18; NuGet global tool plus SSHFling library pack, "
...
PASS_NATIVE_EVIDENCE = (
    "make package-native-libraries VERSION=0.1.18; warning-clean C11/C++17 Ninja/Release "
...
PASS_PERL_EVIDENCE = (
    "make package-perl VERSION=0.1.18; MakeMaker test/dist, archive inspection, isolated "
    "INSTALL_BASE module/CLI execution, init workflow, and removal validation"
)
PASS_GO_EVIDENCE = (
    "make package-go VERSION=0.1.18; go test/vet/install and archive validation in "
    "packaging/build-go.sh"
)
PASS_RUST_EVIDENCE = (
    "make package-rust VERSION=0.1.18; cargo fmt/test/clippy/package/install/uninstall and "
    "publish dry-run evidence"
)
PASS_PHP_EVIDENCE = (
    "make package-php VERSION=0.1.18; Composer validate/archive/install/autoload/CLI/remove "
    "validation in packaging/build-php.sh"
)
PASS_RUBY_EVIDENCE = (
    "make package-ruby VERSION=0.1.18; gem and Bundler install/CLI/uninstall validation in "
    "packaging/build-ruby.sh"
)
PASS_SCRIPT_EVIDENCE = (
    "make test VERSION=0.1.18; shell syntax checks through release validation; "
    "container production test"
)
PASS_SCRIPTING_LANGUAGE_EVIDENCE = (
    "make package-scripting-languages VERSION=0.1.18; versioned archive build, isolated "
...
LANGUAGE_SUPPORT: list[dict[str, str]] = [
    ...
    row("Make",
        ...
        "make test VERSION=0.1.18; package build commands; release readiness commands",
    ...
    row(
        ...
        "docker build -f tests/docker/Dockerfile.production -t sshfling-production-test:0.1.18 .; docker run --rm sshfling-production-test:0.1.18",
