...
def direct_download_requirements(version: str, repo_root: Path) -> list[str]:
    return [
        ...
        f"sshfling-cli-{version}.jar",
        f"sshfling-cli-{version}-javadoc.jar",
        f"sshfling-cli-{version}-sources.jar",
        f"sshfling-cli-{version}.pom",
        f"sshfling-{version}.tgz",
        f"sshfling-{version}-py3-none-any.whl",
        f"sshfling-go-{version}.zip",
        f"sshfling-cli-{version}.crate",
        f"sshfling-php-{version}.zip",
