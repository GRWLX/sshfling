...
DEPLOYMENTS.extend(
    [
        ...
        validated_batch_package(
            ...
            "The per-language validator runs R CMD build, R CMD check, and R CMD INSTALL at VERSION=0.1.19.",
...
DEPLOYMENTS.append(
    validated_batch_package(
        ...
        "The scripting batch builds the archive and CI requires a PASS Guile runtime row at VERSION=0.1.19.",
...
DEPLOYMENTS.extend(
    [
        validated_batch_package(
            ...
            "The per-language validator installs and precompiles the package, runs Pkg.test, and executes an external consumer at VERSION=0.1.19.",
...
CATALOG_SURFACES.extend(
    [
        ...
        blocked_runtime(
            ...
            "library",
            "sshfling-j-VERSION.tar.gz",
            "source publication passes, but the J consumer failed the exact-version output contract in the VERSION=0.1.19 full batch run",
