...
require_contains "index.html" "dotnet tool install --global SSHFling.Tool"
require_contains "index.html" "dotnet tool uninstall --global SSHFling.Tool"
require_contains "index.html" "SSHFling.Tool.${version}.nupkg"
require_contains "index.html" "SSHFling.${version}.nupkg"
require_contains "index.html" "SSHFlingRunner.Run"
require_contains "index.html" "Visual Basic"
require_contains "index.html" "F#"
require_contains "index.html" "Java executable JAR"
require_contains "index.html" "java -jar"
require_contains "index.html" "sshfling-cli-${version}.jar"
require_contains "index.html" "sshfling-cli-${version}-javadoc.jar"
...
require_contains "index.html" "sshfling-${version}.tgz"
require_contains "index.html" "Python wheel"
require_contains "index.html" "pipx install"
require_contains "index.html" "pipx uninstall sshfling"
require_contains "index.html" "sshfling-${version}-py3-none-any.whl"
require_contains "index.html" "Go module"
require_contains "index.html" "go install ./cmd/sshfling"
require_contains "index.html" "sshfling-go-${version}.zip"
require_contains "index.html" "Rust crate"
require_contains "index.html" "cargo install --path"
require_contains "index.html" "cargo uninstall sshfling-cli"
require_contains "index.html" "sshfling-cli-${version}.crate"
require_contains "index.html" "PHP Composer package"
require_contains "index.html" "composer require --working-dir"
require_contains "index.html" "composer remove --working-dir"
require_contains "index.html" "sshfling-php-${version}.zip"
require_contains "index.html" "Ruby gem"
require_contains "index.html" "gem install --local"
require_contains "index.html" "gem uninstall --all --executables --bindir"
require_contains "index.html" "sshfling-${version}.gem"
require_contains "index.html" "C and C++ native libraries"
require_contains "index.html" "sshfling-native-${version}.tar.gz"
require_contains "index.html" "find_package(SSHFling CONFIG REQUIRED)"
require_contains "index.html" "SSHFling::shared"
require_contains "index.html" "SSHFling::static"
require_contains "index.html" "pkg-config --cflags --libs sshfling"
require_contains "index.html" "Perl source distribution"
...
require_contains "index.html" "DisplayVersion"
require_contains "windows/uninstall.ps1" "DisplayVersion"
require_contains "windows/uninstall.ps1" "DisplayVersion -eq \"$version\""
if grep -q "__VERSION__" "$public_dir/windows/uninstall.ps1" >/dev/null 2>&1; then
  fail "windows/uninstall.ps1 contains an unreplaced version placeholder"
fi
require_contains "index.html" "URLInfoAbout"
require_contains "windows/install.ps1" "Get-AuthenticodeSignature"
require_contains "macos/install-pkg.sh" "pkgutil --check-signature"
require_contains "macos/install-pkg.sh" "xcrun stapler validate"
require_contains "macos/install-pkg.sh" "spctl -a -vv -t install"
